...
class TargetCoder(object):
    def __init__(self, regression_type, anchor_sizes, anchor_strides, target_type='3D'):
...
class PoseHead(nn.Module):
    def __init__(self, in_channel, n_class, n_conv, prior, regression_type):
        ...
        #     torch.nn.init.constant_(self.pose_pred.bias, 4)
...
class PoseModule(nn.Module):
    def __init__(self, cfg, backbone):
        ...
        self.head = PoseHead(out_channel, n_class, n_conv, prior, regression_type)
        ...
        self.anchor_generator = make_anchor_generator_atss(anchor_sizes, anchor_strides)
