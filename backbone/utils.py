...
# params is output of sigmoid (0-1) in format of (sigma_x, sigma_y, rou)
# sigma_x = params[:,:,0] * max_sigma + 0.01
# sigma_y = params[:,:,1] * max_sigma + 0.01
# rou = 1.98*params[:,:,2] - 0.99 # out range (-0.99, 0.99)
