...
from .utils import sigmaBranch, fusionBranch, smooth_func
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out2 = self.features.init_block(x)
        out2 = self.features.stage1(out2)
        out3 = self.features.stage2(out2)
        out4 = self.features.stage3(out3)
        out5 = self.features.stage4(out4)
        ...
        if False:
            ...
            wts2 = self.features.fusion1(out2)
            param2 = self.features.sigma1(out2)
            ...
            wts3 = self.features.fusion2(out3)
            param3 = self.features.sigma2(out3)
            ...
            wts4 = self.features.fusion3(out4)
            param4 = self.features.sigma3(out4)
            ...
            #wts5 = self.features.fusion4(out5)
            #param5 = self.features.sigma4(out5)
        ...
        return [None, out2, out3, out4, out5]
